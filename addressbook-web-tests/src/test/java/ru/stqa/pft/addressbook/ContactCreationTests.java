...
public class ContactCreationTests {
  ...
  public void testContactCreation() {
    ...
    fillContactForm(new ContactData("test1", "test2", "test3", "test4", "test5", "testCompany", "testAddress", "1234567890", "2345678901", "34567890123", "5678", "gavrilova.irina@gmail.com", "testHomepage"));
  ...
  private void fillContactForm(ContactData contactData) {
    ...
    wd.findElement(By.name("company")).sendKeys(contactData.getCompaby());
