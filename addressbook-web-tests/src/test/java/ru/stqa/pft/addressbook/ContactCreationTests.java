...
public class ContactCreationTests {
  ...
  public void testContactCreation() {
    ...
    fillContactForm("test1", "test2", "test3", "test4", "test5", "testCompany", "testAddress", "1234567890", "2345678901", "34567890123", "5678", "gavrilova.irina@gmail.com", "testHomepage");
  ...
  private void fillContactForm(String firstname, String middlename, String lastname, String nickname, String title, String compaby, String address, String home, String mobile, String work, String fax, String email2, String homepage) {
    ...
    wd.findElement(By.name("company")).sendKeys(compaby);
